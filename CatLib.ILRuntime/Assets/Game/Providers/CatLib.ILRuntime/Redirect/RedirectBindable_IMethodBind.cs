...
{
    /// <summary>
    /// Bindable_IMethodBind 重定向
    /// </summary>
    internal static unsafe class RedirectBindable_IMethodBind
    {
        /// <summary>
        /// 重定向映射表
        /// </summary>
        ...
        /// <summary>
        /// 构建 Bindable_IMethodBind 重定向
        /// </summary>
        static RedirectBindable_IMethodBind()
        {
        ...
        {
            var methods = Arr.Merge(typeof(IBindable<IMethodBind>).GetMethods(),
                typeof(Bindable<IMethodBind>).GetMethods());
            ...
            CLRMethod method, bool isNewObj)
        {
            ...
            var instanceOfThisMethod =
                (IBindable<IMethodBind>)typeof(IBindable<IMethodBind>).CheckCLRTypes(StackObject.ToObject(ptrOfThisMethod,
